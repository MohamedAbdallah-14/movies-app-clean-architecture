  ...
  group('getPersonDetails', () {
    ...
    test(
      ...
      () async {
        ...
        // assert
        expect(result, equals(personEntity));
      },
    );
  ...
  group('getPersonImages', () {
    ...
    test(
      ...
      () async {
        ...
        // act
        await personRemoteDataSource.getPersonImages(66633);
        // assert
    ...
    test(
      ...
      () async {
        ...
        successMock(urlPersonImages, jsonReader('person_images.json'));
        // act
        final result = await personRemoteDataSource.getPersonImages(66633);
        // assert
        expect(
          result,
          equals(personImagesEntity),
        );
      },
    );
    ...
    test(
      ...
      () async {
        ...
        // act
        final result = personRemoteDataSource.getPersonImages(66633);
        // assert
        expect(() async => result,
            throwsA(const ServerException('Something went wrong!')));
      },
